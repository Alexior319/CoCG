...
uint8_t getNodeType(const std::string& expr,
                    uint8_t def = plansys2_msgs::msg::Node::NONE);
...
std::string toString(const plansys2_msgs::msg::Tree& tree, uint32_t node_id = 0,
                     bool negate = false);
...
plansys2_msgs::msg::Node::SharedPtr fromString(
    plansys2_msgs::msg::Tree& tree, const std::string& expr,
    bool negate = false, uint8_t parent = plansys2_msgs::msg::Node::NONE);

plansys2_msgs::msg::Tree fromString(
    const std::string& expr, bool negate = false,
    uint8_t parent = plansys2_msgs::msg::Node::NONE);
...
void getPredicates(std::vector<plansys2_msgs::msg::Node>& predicates,
                   const plansys2_msgs::msg::Tree& tree, uint32_t node_id = 0,
                   bool negate = false);
