...
class FunctionModifier : public Condition {
 public:
  ...
  FunctionModifier(const std::string& name, Function* f,
                   const IntVec& p = IntVec());

  FunctionModifier(const std::string& name, const FunctionModifier* i,
                   Domain& d);
...
class Assign : public FunctionModifier {
 public:
  ...
  Assign(Function* f, const IntVec& p = IntVec())
...
class Decrease : public FunctionModifier {
 public:
  ...
  Decrease(Function* f, const IntVec& p = IntVec())
