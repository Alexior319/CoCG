...
(:init
	...
	(unknown (at_soil_sample waypoint0))
	(unknown (at_soil_sample waypoint2))
	(unknown (at_soil_sample waypoint4))
	(unknown (at_soil_sample waypoint5))
	(unknown (at_soil_sample waypoint7))
	(unknown (at_soil_sample waypoint8))
	(unknown (at_soil_sample waypoint10))	 
