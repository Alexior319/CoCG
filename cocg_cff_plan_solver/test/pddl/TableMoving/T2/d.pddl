...
(define (domain Tablemover-2)
	...
	(:action joint_drop_table
		:parameters (?a1 - agent ?a2 - agent ?t - table ?r1 - room)
		:precondition (and
			(in ?a1 ?r1)(in ?a2 ?r1)
			(lifting ?a1 ?t) (lifting ?a2 ?t)
			(diff_agent ?a1 ?a2))
		:effect (and (not(lifting ?a1 ?t))
			(not(lifting ?a2 ?t))
